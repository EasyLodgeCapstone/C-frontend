...
import SignupSkeleton from "../Comp/Loading";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0e1a] via-[#0f1a2e] to-[#0a1628] flex items-center justify-center px-4 py-8">
      ...
      >
        ...
        >
          Welcome back to Nova-Wealth Admin
        </p>

        {/* Error Message */}
        {error && (
          <div className="mb-4 p-3 bg-red-500/10 border border-red-500/20 rounded-lg animate-fadeIn">
            <p
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-right">
            <Link
              ...
              className={`${raleway.className} text-xs text-[#94a3b8] hover:text-blue-400 transition-colors`}
            >
              Forgot Password?
            </Link>
          </div>
        ...
        {/* Back to Home */}
        {/* <p className={`${raleway.className} text-center text-[#94a3b8]/60 text-xs mt-3`}>
          <Link
            href="/"
