    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      ...
      <div className="relative bg-black dark:bg-white text-white dark:text-gray-900 py-16 md:py-24 transition-colors">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          <div className="text-center">
            ...
            <p className={`${raleway.className} text-sm md:text-base font-light text-gray-400 dark:text-gray-500 tracking-wider`}>
              WE`RE HERE TO HELP
            </p>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* WhatsApp Card */}
          <div className="group bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 hover:border-black dark:hover:border-white transition-all duration-500 overflow-hidden">
            <div className="p-8 text-center">
              <div className="w-20 h-20 bg-green-50 dark:bg-green-950/50 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-500">
              ...
              <p className={`${raleway.className} text-gray-500 dark:text-gray-400 text-sm mb-4`}>
                Chat with us directly
              </p>
              <p className={`${raleway.className} text-sm text-gray-400 dark:text-gray-500 mb-6`}>
          ...
          <div className="group bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 hover:border-black dark:hover:border-white transition-all duration-500 overflow-hidden">
            <div className="p-8 text-center">
              <div className="w-20 h-20 bg-red-50 dark:bg-red-950/50 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-500">
        ...
        <div className="mt-16 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className={`${caveat.className} text-gray-400 dark:text-gray-500 text-lg`}>
              💬 We typically respond within 24 hours
            </p>
            <p className={`${raleway.className} text-xs text-gray-400 dark:text-gray-500 mt-2 tracking-wider`}>
